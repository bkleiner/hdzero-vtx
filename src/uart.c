...
volatile C51_XDAT uint8_t RS_buf[BUF_MAX];
#ifdef EXTEND_BUF
volatile C51_XDAT uint16_t RS_in = 0, RS_out = 0;
         volatile __bit RS_Xbusy = 0;
#else
volatile C51_XDAT uint8_t RS_in = 0, RS_out = 0;
         volatile __bit RS_Xbusy = 0;
#endif

volatile C51_XDAT uint8_t RS_buf1[BUF1_MAX];
#ifdef EXTEND_BUF1
volatile C51_XDAT uint16_t RS_in1 = 0, RS_out1 = 0;
         volatile __bit RS_Xbusy1 = 0;
#else
volatile C51_XDAT uint8_t RS_in1 = 0, RS_out1 = 0;
        volatile __bit RS_Xbusy1 = 0;
#endif
