...
PDATA_SEG cameraConfig_t camCfg;
PDATA_SEG cameraConfig_t camCfg_Menu;
PDATA_SEG cameraConfig_t camCfg_Cur;
PDATA_SEG cameraConfig_t camCfg_EEP[RUNCAM_PROFILE_M_TYPE];
