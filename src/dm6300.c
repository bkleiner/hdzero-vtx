...
static const dm6300_reg_value_t dm6300_init2_regs_bw27[] = {
    ...
    {0x3, 0x234, 0x10000000},
    {0x3, 0x238, 0x000000BF},
    {0x3, 0x23C, 0x15530610}, // 0x15840410  0x15530610
    {0x3, 0x240, 0x3FFC0047}, // 0x0001C047  0x3FFC0047
    {0x3, 0x244, 0x00188A13}, // 0x00188A17
    {0x3, 0x248, 0x00000000},
    ...
    {0x0, 0x000, 0x00000000}, // pad to the same size
};
